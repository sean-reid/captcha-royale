...
fn compute_time_limit(captcha_type: CaptchaType, complexity: f32) -> u32 {
    let (min_time, max_time) = match captcha_type {
        ...
        CaptchaType::DotCount => (3_000, 8_000),
        CaptchaType::ClockReading => (3_000, 8_000),
        CaptchaType::FractionComparison => (3_000, 7_000),
        CaptchaType::GraphReading => (3_000, 8_000),
        // Tier 2
        CaptchaType::RotatedObject => (5_000, 11_000),
        CaptchaType::PartialOcclusion => (5_000, 13_000),
        CaptchaType::SemanticOddity => (5_000, 15_000),
        CaptchaType::ToneRhythm => (5_000, 12_000),
        CaptchaType::ColorPerception => (3_000, 9_000),
        CaptchaType::MirrorMatch => (4_000, 10_000),
        CaptchaType::BalanceScale => (4_000, 10_000),
        CaptchaType::WordUnscramble => (8_000, 20_000),
        CaptchaType::GradientOrder => (4_000, 10_000),
        CaptchaType::OverlapCounting => (4_000, 10_000),
        CaptchaType::RotationPrediction => (4_000, 10_000),
        // Tier 3
        CaptchaType::AdversarialImage => (6_000, 14_000),
        CaptchaType::SequenceCompletion => (6_000, 16_000),
        ...
        CaptchaType::PathTracing => (6_000, 15_000),
        CaptchaType::BooleanLogic => (5_000, 14_000),
        // Tier 4
