...
interface ColorCaptchaProps {
  instance: CaptchaInstance;
  onSubmit: (answer: PlayerAnswer) => void;
  disabled?: boolean;
}

export function ColorCaptcha({ instance, onSubmit, disabled }: ColorCaptchaProps) {
  ...
  // Highlight selected tile by injecting a style
  ...
  return (
    <div style={styles.container}>
      <div style={styles.label}>Click the differently shaded tile</div>
      <div
        ref={svgRef}
